...
//@interface crowditObject : NSObject
//@end

@interface crowditObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[crowditObject class]])
		{
			for (NSString *key in [[(crowditObject*)o modules] allKeys])
			{
