...
// in simulator we redefine to format for crowdit Developer console
...
{\
	NSString * exceptionName = [@"org.crowdit." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.crowdit";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIcrowditNativeItemNone = -1, 
	UIcrowditNativeItemSpinner = -2,
	UIcrowditNativeItemProgressBar = -3,
	
	UIcrowditNativeItemSlider = -4,
	UIcrowditNativeItemSwitch = -5,
	UIcrowditNativeItemMultiButton = -6,
	UIcrowditNativeItemSegmented = -7,
	
	UIcrowditNativeItemTextView = -8,
	UIcrowditNativeItemTextField = -9,
	UIcrowditNativeItemSearchBar = -10,
	
	UIcrowditNativeItemPicker = -11,
	UIcrowditNativeItemDatePicker = -12,
	
	UIcrowditNativeItemInfoLight = -13,
	UIcrowditNativeItemInfoDark = -14,
	
	UIcrowditNativeItemDisclosure = -15,
	
	UIcrowditNativeItemContactAdd = -16
};
